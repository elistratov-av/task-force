...
<div class="my-profile-form">
    ...
    <div class="photo-editing">
        ...
        <?= $form->field($user, 'avatarFile', ['template' => '{input}'])->fileInput(['hidden' => true, 'id' => 'button-input']) ?>
    ...
    <div class="form-group">
        <?= $form->field($user, 'categories')->checkboxList(array_column(Category::find()->all(), 'name', 'id'),
    ...
    <?= $form->field($user, 'old_password')->passwordInput(['autocomplete' => 'new-password']) ?>
